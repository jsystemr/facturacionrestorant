 ...
 * @author jramos
 */
public class panelPagofacturav2 extends javax.swing.JPanel implements ActionListener {
    ...
    public panelPagofacturav2() {
        initComponents();
    }

    public panelPagofacturav2(int fac, Date fecha, BigDecimal tot) {
        initComponents();
        txtfac.setText("" + fac);
    ...
    private void btnpayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpayActionPerformed
        ...
        if (pay.doubleValue() >= 0) {
            ...
            pago=true;
             ...
             jd.dispose();
            /*Factura fpag = ((frmFacturav2) this.getParent()).jpfac.findFactura(new FacturaPK(nfac, fecha));
            fpag.setEstadofact(new Estadofact(1));
            fpag.setEfectivo(pay);
            try {
                ((frmFacturav2) this.getParent()).jpfac.edit(fpag);
            } catch (Exception ex) {
                Logger.getLogger(panelPagofactura.class.getName()).log(Level.SEVERE, null, ex);
            }*/
        }
