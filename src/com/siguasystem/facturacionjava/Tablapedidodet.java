 ...
 * @author juan
 */
public class Tablapedidodet extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"#","Producto", "Nombre", "Cantidad", "Precio","Comentario"};
    private Object[][] data = {};
