 ...
 * @author juan
 */
public class TablabuscaCorrela extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"ID","CAI", "Formato", "Fecha Vencimiento","Nro. Final"};
    private Object[][] data = {};
