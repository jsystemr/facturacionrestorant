 ...
 * @author juan
 */
public class Tablabuscapro extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"#","Cod. Producto", "Descripcion", "Cantidad Existencia", "Precio Venta","Ubicacion","Proveedor","Nombre Proveedor"};
    private Object[][] data = {};
