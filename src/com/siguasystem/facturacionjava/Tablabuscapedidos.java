 ...
 * @author juan
 */
public class Tablabuscapedidos extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"ID","Correo", "Coordenadas", "RTN", "Celular","Productos"};
    private Object[][] data = {};
