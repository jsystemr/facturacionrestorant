 ...
 * @author juan
 */
public class frmFacturav4 extends javax.swing.JFrame {
    ...
    public void asginarFocoEnter() {
        ...
        cambiarFoco(cbotipoorden); cambiarFoco(txtcodcli);
        cambiarFoco(txtnombre);cambiarFoco(txtdir);
        cambiarFoco(txtidpro);cambiarFoco(btnfincli);
        cambiarFoco(txtcan); cambiarFoco(txtdesc);
        cambiarFoco(txtcomen);cambiarFoco(txtidcli);
    }
    ...
    public frmFacturav4(FacturaPK pkf) {
        initComponents();
    ...
    public void regHistopro(String t,int ex,String pro) throws NumberFormatException, Exception {
        ...
        hp.setTipo(t);hp.setEstado((short)1);
    ...
    public void dialogBuscaCli() {
     ...
     public void dialogBuscaCliv2() {
       ...
       // frmfCli2.setLocation(this.getDesktopPane().getWidth() / 4, 0);
        ...
        frmfCli2.setClosable(true);frmfCli2.setEnabled(true);
                    ...
                    if (nuevafac > 0) {
                        try {
                            ...
                            try {
                                ...
                                Logger.getLogger(frmFacturav4.class.getName()).log(Level.SEVERE, null, ex);
                            }
    ...
    private void CerrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CerrarActionPerformed
        // TODO add your handling code here:
        //cerrarForm();
         if (JOptionPane.showConfirmDialog(null, "Esta seguro de salir, sino a Guarda o Actualiza Perdera la Informacion?", "Saliendo de la Factura!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            cerrarForm();
       }else{
        //this.setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFacturav4.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmFacturav4().setVisible(true);
            }
        });
    }
