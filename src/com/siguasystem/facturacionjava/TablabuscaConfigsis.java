 ...
 * @author juan
 */
public class TablabuscaConfigsis extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"#","ID", "Descripcion", "Valor", "Fecha creacion","Estado"};
    private Object[][] data = {};
