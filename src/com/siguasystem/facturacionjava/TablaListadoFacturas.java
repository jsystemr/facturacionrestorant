 ...
 * @author juan
 */
public class TablaListadoFacturas extends AbstractTableModel implements TableModelListener {

    private String[] columnNames = {"#", "Nro. de Factura", "Cliente", "Orden/Pago En", "Total", "Estado"};
    private Object[][] data = {};
