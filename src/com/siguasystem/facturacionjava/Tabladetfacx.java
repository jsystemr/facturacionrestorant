 ...
 * @author juan
 */
public class Tabladetfacx extends AbstractTableModel {

    private String[] columnNames = {"#","Nro. Factura", "Cod. Producto", "Descripcion","Comentarios", "Cantidad", "Precio","Descuento","ISV","Subtotal"};
    private Object[][] data = {};
