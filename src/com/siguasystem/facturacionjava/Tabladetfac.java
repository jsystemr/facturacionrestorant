 ...
 * @author juan
 */
public class Tabladetfac extends AbstractTableModel {

    private String[] columnNames = {"#", "Cod. Producto", "Descripcion","Comentarios", "Cantidad", "Precio","Descuento","ISV","Subtotal"};
    private Object[][] data = {};
