 ...
 * @author jramos
 */
public class panelPagofacturaOnline extends javax.swing.JPanel{ //implements ActionListener {
    ...
    public panelPagofacturaOnline() {
        initComponents();
    }

    public panelPagofacturaOnline(int fac, Date fecha, BigDecimal tot) {
        initComponents();
        txtfac.setText("" + fac);
