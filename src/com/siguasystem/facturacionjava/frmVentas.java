 ...
 * @author jramos
 */
public class frmVentas extends javax.swing.JInternalFrame implements ActionListener  {
    ...
    FacturaPK pkfact=null;//Toma valor si la factura existen
    DetallefacturaPK pkdfact=null;//Toma valor si el detalle existe
    Integer nuevafac = 0;
    Integer estado = 1;
    Integer buspro = 0;
    ...
    public frmVentas(FacturaPK pkf) {
        initComponents();
        this.toFront();
    ...
    private void initComponents() {
        ...
        cbotipofac.setNextFocusableComponent(cbotipoorden);
    ...
    private void btnprintfacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintfacActionPerformed
        try {
            ...
            BigDecimal totsen = new BigDecimal(txttot.getText());
             guardaroupdateFactura();
            frmPagofac pagofrm = new frmPagofac(pkfact,totsen);
            pagofrm.f = factura;
            pagofrm.ldf=lsdetfac;
            this.getDesktopPane().add(pagofrm);
            pagofrm.setFocusable(true);
            pagofrm.setClosable(true);
            pagofrm.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
            pagofrm.pack();
            pagofrm.setVisible(true);
            this.getDesktopPane().selectFrame(true);
            pagofrm.toFront();
            pagofrm.show();
            cerrarForm();
           /* Date date = formatfac.parse(txtfecha.getText());
...
// addprolista();
    ...
    public void guardaroupdateFactura() {
        // TODO add your handling code here:
        try {
            ///btnsavefac.setEnabled(false);//Activar si es necesario
    ...
    public void cerrarForm() {
        //emFac.createEntityManager().flush();
        //this.emFac.close();
        this.dispose();
    }
    ...
    public void dialogBuscaCliv2() {
        ...
        frmfCli2.pack();
        frmfCli2.show();
        frmfCli2.addInternalFrameListener(new InternalFrameListener() {
            @Override
