 ...
 * @author juan
 */
public class frmListadoFacturasv2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtfiltroopen, javax.swing.GroupLayout.PREFERRED_SIZE, 535, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(103, 103, 103)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtfiltroopen3, javax.swing.GroupLayout.PREFERRED_SIZE, 567, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(tabfac, javax.swing.GroupLayout.PREFERRED_SIZE, 932, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabfac, javax.swing.GroupLayout.DEFAULT_SIZE, 642, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addGap(25, 25, 25)
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            if (listado3.getRowCount() > 0) {
                ...
                if (pselstring.length() > 0) {
                    verificaEstadofac2();//verificaEstadofac();
                }
            }
        }
    ...
    public void verificaEstadofac2() {
        Factura fsel = (Factura) finfac.getEntityManager().createNativeQuery("select * from factura where idfactura=" + pselstring, Factura.class).getSingleResult();
        System.out.println(fsel.getFacturaPK());
        frmFacturav4 frmfac3 = new frmFacturav4(fsel.getFacturaPK());
    ...
    public void finfacopen2(Integer a) {
        ...
        if (a == 3) {
            if (txtfiltroopen3.getText().length() > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListadoFacturasv2.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListadoFacturasv2().setVisible(true);
            }
        });
    }
