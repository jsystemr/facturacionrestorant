 ...
 * @author juan
 */
public class frmFacturav6 extends javax.swing.JInternalFrame implements ActionListener {
    ...
    public frmFacturav6(FacturaPK pkf) {
        initComponents();
        detfac.setModel(dt.crearTabla());
        ...
        try {
            if (prosel != null) {
                if (prosel.getIdProducto().length() > 0) {
                    ...
                    padd.setPrecio(BigDecimal.valueOf(prosel.getPrecio() - Double.parseDouble(txtisv.getValue().toString())));
                    calcSubtotal();
    ...
    public void iniciarFactura() {
        ...
        try {
            ...
            if (ultimaFact()> (lcorre.getRangofin() - 201)) {
                        ...
                        try {
                            if (btnprintfac.isEnabled()) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(frmFacturav6.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
    ...
    public DefaultComboBoxModel ObtenerListaTipofac() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        try {
            List<Tipofactura> ltpf=ltipfac.ListaTipoFac();
    ...
    public DefaultComboBoxModel ObtenerListausu() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        try {
            List<Usuario> lu= jpusu.ListaUsu();
            for (Usuario it :lu) {
                Usuario p = it;
                modelo.addElement(p);
            }
    ...
    public DefaultComboBoxModel ObtenerListaTipoor() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        try {
            List<Tiporden> lor=ltipor.ListaTipoOrd();
            for (Tiporden it : lor) {
                Tiporden p = it;
                modelo.addElement(p);
            }
    ...
    public DefaultComboBoxModel ObtenerListaEmp() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        try {
            List<Empresa> lemp=lempre.ListaEmpresa();
            for (Empresa it :lemp ) {
                Empresa p = it;
                modelo.addElement(p);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFacturav6.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmFacturav6().setVisible(true);
            }
        });
    }
