...
public class CategoriaproductoJpaController implements Serializable {
    ...
    public void create(Categoriaproducto categoriaproducto) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findCategoriaproducto(categoriaproducto.getIdCategoria()) != null) {
    ...
    public void edit(Categoriaproducto categoriaproducto) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = categoriaproducto.getIdCategoria();
    ...
    public Categoriaproducto findCategoriaproducto(String id) {
        EntityManager em = getEntityManager();
        try {
