        ...
        try {
            ...
            for (Factura facturaListOldFactura : facturaListOld) {
                if (!facturaListNew.contains(facturaListOldFactura)) {
                    ...
                    illegalOrphanMessages.add("You must retain Factura " + facturaListOldFactura + " since its usuario field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Factura facturaListOrphanCheckFactura : facturaListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Factura " + facturaListOrphanCheckFactura + " in its facturaList field has a non-nullable usuario field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
