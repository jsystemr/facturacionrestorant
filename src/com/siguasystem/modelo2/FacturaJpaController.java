 ...
 */
package com.siguasystem.modelo2;
...
import com.siguasystem.modelo2.exceptions.NonexistentEntityException;
import com.siguasystem.modelo2.exceptions.PreexistingEntityException;
...
public class FacturaJpaController implements Serializable {
    ...
    public void edit(Factura factura) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Factura persistentFactura = em.find(Factura.class, factura);
